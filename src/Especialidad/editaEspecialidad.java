 ...
 */
public class editaEspecialidad extends javax.swing.JPanel {
    ...
    public editaEspecialidad(Usuario usuario, String ses) {
        initComponents();
        sessionPrograma=ses;
        usr=usuario;
        formatoTabla();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true), "Edita de Especialidad", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Arial", 1, 12))); // NOI18N
        ...
        grupomecanico.setEnabled(false);
        grupomecanico.setNextFocusableComponent(b_guardar);
        ...
        b_cancelar1.setNextFocusableComponent(grupomecanico);
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(IdEspecialidad, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
    ...
    private void b_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_guardarActionPerformed
        ...
        if(usr.getEditaMecanico()==true)
        {
            ...
            {
                JOptionPane.showMessageDialog(null, "¡Selecciona la especialidad que desees modificar!");
    ...
    private void Selecciona2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Selecciona2ActionPerformed
        ...
        if(usr.getEditaMecanico()==true)
        {
            altaEspecialidad obj = new altaEspecialidad(new javax.swing.JFrame(), true, usr, sessionPrograma);
            ...
            if(this.t_datos.getSelectedRow()>=0)
             {
                 ...
                 else
                 {
                     if (JOptionPane.NO_OPTION== opt)
                         JOptionPane.showMessageDialog(null, "¡Selecciona la especialidad correcta para eliminar!");  

                 }  
             }
              else
              {
                  JOptionPane.showMessageDialog(null, "¡Selecciona la especialidad que desees eliminar!");
                  grupomecanico.requestFocus();
              }
        }
        else
    ...
    private boolean modifica()
    {
        ...
        {
            session.beginTransaction();
            Object resp=session.createQuery("from Especialidad obj where obj.descripcion='"+grupomecanico.getText()+"' and obj.idGrupoMecanico!="+IdEspecialidad.getText()).uniqueResult();
            if(resp==null)
            {
                Especialidad objeto = (Especialidad)session.get(Especialidad.class, Integer.parseInt(IdEspecialidad.getText()));
                if(grupomecanico.getText().compareTo("")!=1)
                    objeto.setDescripcion(grupomecanico.getText());                  
    ...
    private boolean eliminar(String idEspecialidad)
    {
        Session session = HibernateUtil.getSessionFactory().openSession();
        try
        {
            session.beginTransaction();
            actor = (Especialidad)session.get(Especialidad.class, Integer.parseInt(idEspecialidad));
            if(actor.getCatalogos().isEmpty()==false)
            {
                session.getTransaction().rollback();
                JOptionPane.showMessageDialog(null, "¡La especialidad esta en uso en un catálogo, no se puede eliminar!");
                return false;
            }
            else
            {
    ...
    public void cajas(boolean descripcion, boolean cancelar, boolean guardar)
    {
