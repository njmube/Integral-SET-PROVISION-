 ...
 * @author ISC_SALVADOR
 */
public class buscaResponsable extends javax.swing.JDialog {

    public static final ArrayList RET_CANCEL =null;
    InputMap map = new InputMap();
    DefaultTableModel model;
    String[] columnas = new String [] {"id","Nombre", "Puesto"};
    Usuario user;
    ...
    public buscaResponsable(java.awt.Frame parent, boolean modal, Usuario u, String ses, Orden ord_act) {
        super(parent, modal);
        sessionPrograma=ses;
        user=u;
        initComponents();
    ...
    private void executeQuery() {
        ...
        try {
            ...
            if(ord_act!=null)
            {
                ...
                Empleado hojalateria=ord_act.getEmpleadoByRHojalateria();
                Empleado mecanica=ord_act.getEmpleadoByRMecanica();
                Empleado suspension=ord_act.getEmpleadoByRSuspension();
                Empleado electrico=ord_act.getEmpleadoByRElectrico();
                Empleado pintura=ord_act.getEmpleadoByRPintura();
                        
                if(hojalateria!=null)
                    model.addRow(new Object[]{hojalateria.getIdEmpleado(), hojalateria.getNombre(), "HOJALATERIA"});
                
                if(mecanica!=null)
                    model.addRow(new Object[]{mecanica.getIdEmpleado(), mecanica.getNombre(), "MECANICA"});
                
                if(suspension!=null)
                    model.addRow(new Object[]{suspension.getIdEmpleado(), suspension.getNombre(), "SUSPENSION"});
                
                if(electrico!=null)
                    model.addRow(new Object[]{electrico.getIdEmpleado(), electrico.getNombre(), "ELECTRICO"});
                
                if(pintura!=null)
                    model.addRow(new Object[]{pintura.getIdEmpleado(), pintura.getNombre(), "PINTURA"});
            }
            else
                t_datos.setModel(ModeloTablaReporte(0, columnas));
            titulos();
