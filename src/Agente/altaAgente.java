 ...
 */
public class altaAgente extends javax.swing.JDialog {
    public static final Agente RET_CANCEL =null;
     ...
     */
    public altaAgente(java.awt.Frame parent, boolean modal, Usuario u, String ses) {
        super(parent, modal);
        user=u;
        sessionPrograma=ses;
        initComponents();
    ...
    private void b_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_guardarActionPerformed
        ...
        if(t_descripcion.getText().compareTo("")!=0)
        {
            try
            {
                ...
                if(consultaAgente(t_descripcion.getText())==false)
                {
                    Agente ajuste= new Agente();
                    ajuste.setNombre(t_descripcion.getText());
        ...
        {
            JOptionPane.showMessageDialog(null, "¡Debe introducir el Agente!");
        }
    ...
    private boolean consultaAgente(String agente)
    {
        List <Object[]> resultList=executeHQLQuery("from Agente obj where obj.nombre='"+agente+"'");
        if(resultList.size()>0)
            return true;
        else
            return false;
    }
    private Agente returnStatus = RET_CANCEL;
}
