 ...
 * @author ISC_SALVADOR
 */
public class buscaUsoCfdi extends javax.swing.JDialog {

    public static final UsoCfdi RET_CANCEL =null;
    //private Session session;
    InputMap map = new InputMap();
    DefaultTableModel model;
    String[] columnas = new String [] {"ID","Descripción", "Inicio Vigencia", "Fin Vigencia"};
    String sessionPrograma="";
    Herramientas h;
    Usuario usr;
    
    /** Creates new form acceso */
    public buscaUsoCfdi(javax.swing.JFrame parent, boolean modal, String ses, Usuario usuario) {
        super(parent, modal);
        sessionPrograma=ses;
        usr=usuario;
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true), "Descripcion Uso Cfdi", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Arial", 1, 11))); // NOI18N
        ...
        t_datos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Descripción", "Inicio Vigencia", "Fin Vigencia"
            }
        ) {
            Class[] types = new Class [] {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(t_datos.getRowCount()>0)
        {
            ...
            {
                UsoCfdi op= new UsoCfdi();
                op.setIdUsoCfdi(t_datos.getValueAt(t_datos.getSelectedRow(), 0).toString());
                op.setDescripcion(t_datos.getValueAt(t_datos.getSelectedRow(), 1).toString());
                if(session!=null)
                    if(session.isOpen())
                        session.close();
                doClose(op);
                ...
                JOptionPane.showMessageDialog(null, "¡No hay un Uso CFDI seleccionado!");
        }
        if(session!=null)
            if(session.isOpen())
                session.close();
...
{
    String consulta="from UsoCfdi obj where obj.descripcion like '%" + t_busca.getText() +"%'";
    ...
    if(resultList.size()>0)
    {
        ...
        {
            UsoCfdi actor = (UsoCfdi) o;
            model.setValueAt(actor.getIdUsoCfdi(), i, 0);
            model.setValueAt(actor.getDescripcion(), i, 1);
            if(actor.getFechaInicioVigencia()!=null)
                model.setValueAt(dateFormat.format(actor.getFechaInicioVigencia()), i, 2);
            else
                model.setValueAt("", i, 2);
            if(actor.getFechaFinVigencia()!=null)
                model.setValueAt(dateFormat.format(actor.getFechaFinVigencia()), i, 3);
            else
    ...
    private UsoCfdi returnStatus = RET_CANCEL; 
