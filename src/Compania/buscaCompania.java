    ...
    private void buscaDato()
    {
        ...
        if(resultList.size()>0)
        {
            ...
            for (Object o : resultList) 
            {
                ...
                model.setValueAt(actor.getIdCompania(), i, 0);
                model.setValueAt(actor.getNombre(), i, 1);
                model.setValueAt(actor.getDireccion(), i, 2);
                model.setValueAt(actor.getPoblacion(), i, 3);
                model.setValueAt(actor.getEstado(), i, 4);
                model.setValueAt(actor.getRepresentante1(), i, 5);
                i++;
            }
        }
        else
