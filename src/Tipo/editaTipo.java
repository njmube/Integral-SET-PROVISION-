 ...
 */
public class editaTipo extends javax.swing.JPanel {
    /**
    ...
    public editaTipo(Usuario usuario, String ses) 
    {
        initComponents();
        sessionPrograma=ses;
        usr=usuario;
    ...
    private void Selecciona3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Selecciona3ActionPerformed
        h=new Herramientas(usr, 0);
        h.session(sessionPrograma);
        altaTipo obj = new altaTipo(new javax.swing.JFrame(), true, usr, sessionPrograma);
