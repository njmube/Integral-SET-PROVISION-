 ...
 */
public class buscaAjustadores extends javax.swing.JDialog {
    ...
    public buscaAjustadores(javax.swing.JFrame parent, boolean modal, String ses, Usuario usuario) {
        super(parent, modal);
        sessionPrograma=ses;
        usr=usuario;
        initComponents();
...
{
    String consulta="from Ajustador obj where obj.nombre like '%" + t_busca.getText() +"%'";
