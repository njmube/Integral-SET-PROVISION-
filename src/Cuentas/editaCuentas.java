...
public class editaCuentas extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true), "Edita Cuentas", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Arial", 1, 12))); // NOI18N
        ...
        b_cancelar1.setNextFocusableComponent(Cuenta);
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(Cuenta, javax.swing.GroupLayout.PREFERRED_SIZE, 254, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void b_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_guardarActionPerformed
        ...
        if(Cuenta.getText().compareTo("")!=0 || jComboBox1.getSelectedItem().toString().compareTo("SELECCIONE-->")!=0 || nombre.getText().compareTo("")!=0)            
        {  
        ...
        {
            JOptionPane.showMessageDialog(null, "¡Selecciona la cuenta que desees modificar!");
            Cuenta.requestFocus();
        }        
    ...
    private void Selecciona2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Selecciona2ActionPerformed
        ...
        {
            borra_cajas();
            String cuen = (String) t_datos.getValueAt(t_datos.getSelectedRow(), 0);
            Cuenta.setText(cuen);
            cu=cuen;
            
            String sald = (String) t_datos.getValueAt(t_datos.getSelectedRow(), 1);
            if(sald.equals("A")){
            ...
            String nom = (String) t_datos.getValueAt(t_datos.getSelectedRow(), 2);
            nombre.setText(nom);
            no=nom;
            cajas(true, true, true, true, true, true);
...
//            cajas(true, true, true, true);
    ...
    private void t_buscaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_t_buscaActionPerformed
        // TODO add your handling code here:
        this.b_buscaActionPerformed(null);
...
//            {
//                if(t_datos.getValueAt(x, 0).toString().indexOf(t_busca.getText().toUpperCase()) != -1 || t_datos.getValueAt(x, 2).toString().indexOf(t_busca.getText().toUpperCase()) != -1)
//                {
...
//        }
    ...
    private void buscaDato()
    {
        ...
        if(resultList.size()>0)
        {
            ...
            {
                Cuentas actor = (Cuentas) o;
                model.setValueAt(actor.getIdCuentas(), i, 0); 
                model.setValueAt(actor.getSaldo(), i, 1);
                model.setValueAt(actor.getNombre(), i, 2);
                i++;
            }
        }
        else
    ...
    private boolean modifica()
    {
        ...
        {
            session.beginTransaction();
            Object resp=session.createQuery("from Cuentas obj where obj.idCuentas='"+Cuenta.getText()+"' and obj.idCuentas!='"+cu+"'").uniqueResult();
            if (resp==null)
            {
                Query q;
                if(jComboBox1.getSelectedIndex()==1)
                    q = session.createQuery("update Cuentas obj set obj.saldo='A', obj.idCuentas='"+Cuenta.getText()+"', obj.nombre='"+nombre.getText()+"' where obj.idCuentas='"+cu+"'");
                else
                    q = session.createQuery("update Cuentas obj set obj.saldo='D', obj.idCuentas='"+Cuenta.getText()+"', obj.nombre='"+nombre.getText()+"' where obj.idCuentas='"+cu+"'");
                q.executeUpdate();
    ...
    private boolean elimina(String idCuenta)
    {
        Session session = HibernateUtil.getSessionFactory().openSession();
        try
        {
            session.beginTransaction();
            actor = (Cuentas)session.get(Cuentas.class, idCuenta);
            if(actor.getRegistros().isEmpty()==false && actor.getProveedorsForCtaAbono().isEmpty()==false && actor.getProveedorsForCtaCargo().isEmpty()==false){
                session.getTransaction().rollback();
                JOptionPane.showMessageDialog(null, "¡La Cuenta esta en uso en un Módulo, no se puede eliminar!");
                return false;
            }
            else
            {
    ...
    public void cajas( boolean tipo, boolean ep, boolean guardar, boolean cancelar, boolean sal, boolean nom1)
    {
        this.Cuenta.setEnabled(tipo);
        this.b_guardar.setEnabled(guardar);
        this.b_cancelar1.setEnabled(cancelar);
        jComboBox1.setEnabled(sal);
        nombre.setEnabled(nom1);
