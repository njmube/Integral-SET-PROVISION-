 ...
 * @author ISC_SALVADOR
 */
public class buscaEmpleado extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Nombre del Empleado", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 11))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(t_datos.getRowCount()>0)
        {
            ...
            {
                Empleado em=(Empleado)session.get(Empleado.class, Integer.parseInt(t_datos.getValueAt(t_datos.getSelectedRow(), 0).toString()));
                if(session!=null)
                    if(session.isOpen())
                        session.close();
                doClose(em);
        ...
        try {
            ...
            if(resultList.size()>0)
            {
                ...
                for (Object o : resultList) 
                {
                    ...
                    model.setValueAt(actor.getPuestos().getNombre(), i, 2);
                    i++;
                }
            }
            else
